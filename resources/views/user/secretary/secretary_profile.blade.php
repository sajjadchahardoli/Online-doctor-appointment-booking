            ...
            <div class="row justify-content-center mt-5 mb-5">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                                    <form method="POST" action="{{route('secretary.dashboard.update_profile',$secretary->id)}}">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" name="id" value="{{$secretary->id}}" required autocomplete="id" autofocus readonly>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="family" type="text" class="form-control @error('family') is-invalid @enderror" name="family" value="{{$secretary->family}}" required autocomplete="family" autofocus>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{$secretary->email}}" required autocomplete="email">
