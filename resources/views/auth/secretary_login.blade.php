...
<div class="container">
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header card-header-color text-white">{{ __('ورود منشي') }}</div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="badge float-left mt-2" style="color: #09015f" href="{{ route('secretary.password.request') }}">
                                        {{ __('فراموشی رمز عبور؟') }}
                                    </a>
                                @endif
                            </div>
