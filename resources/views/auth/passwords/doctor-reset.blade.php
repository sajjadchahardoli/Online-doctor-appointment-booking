...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mt-5">
            <div class="card">
                <div class="card-header card-header-color text-white">{{ __('بازیابی رمزعبور پزشک') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('doctor.password.update') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('رمزعبور جدید') }}</label>
